-- ============================================================================
-- HDB Cleanup — 9/9: ProcessGroup
-- ============================================================================
-- Root parent table. MUST run LAST (after cleanup_08_ProcessInfo.sql).
-- Deletes where ALL existing dates (FirstDate, LastDate, ExportDate)
...
WHERE object_id = OBJECT_ID('ProcessGroup') AND index_id IN (0,1)
