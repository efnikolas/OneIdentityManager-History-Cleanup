-- ============================================================================
-- HDB Cleanup — 5/9: ProcessChain
-- ============================================================================
-- Independent table — no FK dependencies. Can run in parallel with others.
-- Deletes where ThisDate is older than 2 years.
-- Rows with NULL ThisDate are kept.
...
WHERE object_id = OBJECT_ID('ProcessChain') AND index_id IN (0,1)
